...
- [Callout](../callout)
- [Card with tag](../callout)
- [No Icon](/)

- [Image Card](/) ? Internet Image
- [Local Image](/) ? Raw image under static directory.
- [Local Image](/) ? Image under assets directory, processed by Hugo.
...
| ----------- | -------------------------------------------------------------------------------------- |
| `tag`       | Text in tag.                                                                           |
| `tagColor`  | Color of the tag. See [badges](others/#badges) for more information.  |
| `tagIcon`   | Icon of the tag. See [badges](others/#badges) for more information.   |
| `tagBorder` | Border of the tag. See [badges](others/#badges) for more information. |

- [Card with default tag](../callout)
- [Card with red tag](../callout)
- [Card with blue tag](../callout)
- [Card with yellow tag](../callout)
- [Image Card](/) ? Image
- [Image Card](/) ? Image
